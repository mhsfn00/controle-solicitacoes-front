...
export const ExternalMemberRegistryForm: React.FC = () => {
  ...
  return (
    <Form {...form}>
      <FormHeader
        title="Informações do Membro Externo"
        subTitle="Informe os dados do membro externo e sua especialização na banca."
      />
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem className="w-7/10">
              ...
              <FormControl>
                <Input
                  placeholder="Universidade Estadual de Maringá"
                  {...field}
                />
              </FormControl>
            </FormItem>
      ...
      <div className="flex gap-5 py-4">
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem className="w-7/10">
              <FormLabel className="gap-0">Telefone</FormLabel>
              <FormControl>
                <Input
                  placeholder="44997611361"
                  {...field}
                  onChange={(e) => {
                    const onlyNums = e.target.value.replace(/\D/g, '');
                    field.onChange(onlyNums);
