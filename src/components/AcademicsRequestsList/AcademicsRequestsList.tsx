    ...
    <div>
      ...
      <div className="flex flex-wrap gap-6 mt-8">
        <div className="flex items-center p-4 bg-white rounded-lg shadow-md flex-1 min-w-[250px]">
          ...
          <div className="ml-4">
            <div className="text-lg font-semibold">Novos Envio!</div>
            <div className="text-gray-500">Solicitações</div>
          </div>
        ...
        <div className="flex items-center p-4 bg-white rounded-lg shadow-md flex-1 min-w-[250px]">
          ...
          <div className="ml-4">
            ...
            <div className="text-gray-500">Exame de Qualificação</div>
          </div>
              ...
              <TableRow key={index}>
                <TableCell>
                  <div className="font-medium">
                    {solicitacao.academico.nome}
                  </div>
                  <div className="text-sm text-gray-500">
                    {solicitacao.academico.ra}@
                    {solicitacao.academico.email.split('@')[1]}
                  </div>
                </TableCell>
                <TableCell>
                ...
                <TableCell className="text-right">
                  ...
                  >
                    <Link to={`/requisicoes-alunos/${index}`}>Visualizar</Link>
                  </Button>
                </TableCell>
              </TableRow>
            ))}
